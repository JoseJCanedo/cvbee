...
export default function Banner() {
    ...
    if (withinFiveDays) {
        const meetingLocation = (today.getMonth() + 1) % 2 === 0 ? 'Striplin Terrace UMC' : 'Oxbow Meadows' //%20
        const directions = (today.getMonth()) % 2 === 0 ? '32.523631501341896%2C%20-84.92014205292037' : '32.386370054391094%2C%20-84.95877673226478'
        return (
